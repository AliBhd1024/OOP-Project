...
public class Admin
{
    ...
    public boolean checkTakenRestaurant(String restaurantName) {
        for (int i = 0; i < this.restaurants.size(); i++) {
            if(this.restaurants.get(i).restaurantName.equals(restaurantName)) {
                return true;
            }
        }
    ...
    public static int nameToIndex(String name) {
        for (int i = 0; i < admin.size(); i++) {
            if (admin.get(i).username.equals(name)) {
                return i;
            }
        }
    ...
    public int restNameToIndex(String name) {
        for (int i = 0; i < restaurants.size() ; i++) {
            if (restaurants.get(i).restaurantName.equals(name)) {
                return i;
            }
        }
